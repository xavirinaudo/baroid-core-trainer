    ...
    questions: [
      {
            ...
            "options": [
                  {
                        "label": "Increased fluid loss due high ECDs",
                        "value": "increased_fluid_loss"
                  },
                  {
                        "label": "Stuck pipe due differential sticking",
                        "value": "stuck_pipe_due_diff"
                  },
                  {
                        "label": "Increase of ROP and lowering of rig time",
                        "value": "increase_rop_error"
                  },
                  {
                        "label": "Poor cement jobs due thick filtercake",
                        "value": "poor_cement_jobs"
                  },
                  {
                        "label": "Increased lubrication",
                        "value": "increased_lubrication_error"
                  },
                  {
                        "label": "Increase of rig time by lowering ROP",
                        "value": "increase_rig_time"
                  },
                  {
                        "label": "Increased fluid waste volumes",
                        "value": "increased_waste_volumes"
                  },
                  {
                        "label": "Good cement jobs due thinner filtercake",
                        "value": "good_cement_jobs_error"
                  }
            ],
            "answer": [
      ...
      },
      {
            ...
            "options": [
                  {
                        "label": "Solids Control equipment typically provides discharged solids that are under the permitted ROC% limit to allow discharging them overboard",
                        "value": "roc_limit_error"
                  },
                  {
                        "label": "Solids control operations address the first step of the waste management hierarchy by reducing the amount of generated waste",
                        "value": "reduce_waste_step"
                  },
                  {
                        "label": "Solids control equipment treats and segregates all waste bi-products from the discharged waste streams",
                        "value": "treat_all_error"
                  },
                  {
                        "label": "Solids Control operations should only be used with expensive fluid systems",
                        "value": "expensive_systems_error"
                  },
                  {
                        "label": "Solid control equipment is purposed to optimizes the drilling fluid performance and maximize drilling efficiencies",
      ...
      },
      {
            ...
            "options": [
                  {
                        "label": "Increase penetration rates (ROP\u2019s)",
                        "value": "rop"
                  },
                  {
                        "label": "Provide better cementing jobs",
                        "value": "cementing"
                  },
                  {
                        "label": "Lower probability of differential sticking",
                        "value": "sticking"
                  },
                  {
                        "label": "Provide Lower Equivalent Circulating Densities (ECD\u2019s)",
                        "value": "lower_ecd"
                  },
                  {
                        "label": "Reduced torque and drag",
                        "value": "torque_drag"
                  }
            ],
            "answer": "lower_ecd",
      ...
      },
      {
            ...
            "options": [
                  {
                        "label": "Provide wellbore stability",
                        "value": "wellbore_stability"
                  },
                  {
                        "label": "Transport Cuttings to Surface",
                        "value": "transport_cuttings"
                  },
                  {
                        "label": "Suspend and release cuttings",
                        "value": "suspend_cuttings"
                  },
                  {
                        "label": "Protect against corrosion",
                        "value": "corrosion"
                  },
                  {
                        "label": "Provide hydraulic power to downhole tools",
                        "value": "hydraulic_power"
                  },
                  {
                        "label": "Control subsurface pressures",
                        "value": "control_pressures"
                  }
            ],
            "answer": [
                  "wellbore_stability",
      ...
      },
      {
            ...
            "options": [
                  {
                        "label": "Micron size of particles is predominantly <74 microns",
                        "value": "size_less_74"
                  },
                  {
                        "label": "Non-abrasive",
                  ...
                  {
                        "label": "Chemically reactive",
                        "value": "reactive_error"
                  },
                  {
                        "label": "High specific gravity",
                        "value": "high_sg"
                  },
                  {
                        "label": "Chemically inert",
                        "value": "chemically_inert"
                  },
                  {
                        "label": "Low specific gravity",
                        "value": "low_sg_error"
                  },
                  {
                        "label": "Micron size of particles is predominantly >74 microns",
                        "value": "size_greater_74_error"
                  }
            ],
            "answer": [
                  "size_less_74",
      ...
      },
      {
            ...
            "options": [
                  {
                        "label": "Solid Particle color",
                        "value": "color"
                  },
                  {
                        "label": "Solid Particle Specific Gravity (SG)",
                        "value": "sg"
                  },
                  {
                        "label": "Solid Particle mineralogy",
                        "value": "mineralogy"
                  },
                  {
                        "label": "Solid Particle Reactivity",
                        "value": "reactivity"
                  },
                  {
                        "label": "Solid Particle shape",
                        "value": "shape"
                  },
                  {
                        "label": "Solid Particle strength",
                        "value": "strength"
                  },
                  {
                        "label": "Solid Particle Source",
                        "value": "source"
                  },
                  {
                        "label": "Solid Particle Size",
                        "value": "size"
                  }
            ],
            "answer": [
      ...
      },
      {
            ...
            "options": [
                  {
                        "label": "Solid particle distribution",
                        "value": "distribution"
                  },
                  {
                        "label": "Solid particles density",
                        "value": "density"
                  },
                  {
                        "label": "Solid particles reactiveness",
                        "value": "reactiveness"
                  },
                  {
                        "label": "Solid particles abrasiveness",
                        "value": "abrasiveness"
                  },
                  {
                        "label": "Solid particles surface area",
                        "value": "surface_area"
                  }
            ],
            "answer": "surface_area",
      ...
      },
      {
            ...
            "options": [
                  ...
                  {
                        "label": "Particle surface area",
                        "value": "surface_area"
                  },
                  {
                        "label": "Particle degradation",
                        "value": "degradation"
                  },
                  {
                        "label": "Particle reactiveness",
                        "value": "reactiveness"
                  }
            ],
            "answer": "reactiveness",
      ...
      },
      {
            ...
            "options": [
                  {
                        "label": "Solid Reactiveness",
                        "value": "reactiveness"
                  },
                  {
                        "label": "Solid abrasiveness",
                        "value": "abrasiveness"
                  },
                  {
                        "label": "Solid density",
      ...
      },
      {
            ...
            "options": [
                  {
                        "label": "The clay particles are so fine (small) making removal difficult for conventional solids control equipment",
                        "value": "fine_removal_diff"
                  },
                  {
                        "label": "They consist of mostly abrasive solid particles causing further erosion of equipment.",
                        "value": "abrasive_error"
                  },
                  {
                        "label": "They consist of mostly large solid particles resulting in increased solid surface area and less free liquid available to the mud",
                        "value": "large_surface_error"
                  },
                  {
                        "label": "They consist of mostly colloidal solid particles causing increased solid surface areas and less free liquid providing undesired viscosity of mud",
                        "value": "colloidal_viscosity"
                  }
            ],
            "answer": [
                  "fine_removal_diff",
      ...
      },
      {
            ...
            "options": [
                  {
                        "label": "Excessive hydration of clays",
                        "value": "hydration_error"
                  },
                  {
                        "label": "Excessive dilution as sand is difficult to mechanically remove",
                        "value": "dilution_error"
                  },
                  {
                        "label": "Excessive equipment repair and pump maintenance costs",
                        "value": "equipment_wear"
                  },
                  {
                        "label": "Increased amount of colloidal solid particles",
                        "value": "colloidal_error"
                  }
            ],
      ...
      },
      {
            ...
            "options": [
                  {
                        "label": "Does not lower the solids % in the mud",
                        "value": "does_not_lower"
                  },
                  {
                        "label": "Excessive mud and waste volumes",
                        "value": "excessive_volumes"
                  },
                  {
                        "label": "Increasingly excessive mud maintenance costs",
                        "value": "excessive_costs"
                  },
                  {
                        "label": "Fluid incompatibility with drilled solids",
      ...
      },
      {
            ...
            "options": [
                  {
                        "label": "Operational footprint constraints",
                        "value": "footprint"
                  },
                  {
                        "label": "Only the ability to settle out and remove large solid particles",
                        "value": "large_only"
                  },
                  {
                        "label": "Operational time constraints",
                        "value": "time"
                  },
                  {
                        "label": "All of the above",
      ...
      },
      {
            ...
            "options": [
                  {
                        "label": "Solid particles specific gravity",
                        "value": "sg"
                  },
                  {
                  ...
                  },
                  {
                        ...
                        "value": "fluid_viscosity"
                  },
                  {
                        "label": "Fluid loss into the formation",
                        "value": "fluid_loss_error"
                  },
                  {
                        "label": "Amount of G-force applied",
                        "value": "g_force"
                  }
            ],
            "answer": [
      ...
      },
      {
            ...
            "options": [
                  ...
                  {
                        "label": "De-flocculation",
                        "value": "de_flocculation"
                  },
                  {
                        "label": "Inhibition",
                        "value": "inhibition"
      ...
      },
      {
            ...
            "options": [
                  {
                        "label": "Filtration (wellbore cleanup) Equipment & Services",
                        "value": "filtration"
                  },
                  {
                        "label": "Solids Control & Fluid Treatment Equipment & Services",
                        "value": "solids_control"
                  },
                  {
                        "label": "Waste Disposal & Transportation Equipment & Services",
                        "value": "disposal_error"
                  },
                  {
                        "label": "Waste Handling & Transportation Equipment & Services",
                        "value": "waste_handling"
                  },
                  {
                        "label": "Waste Treatment & Disposal Equipment & Services",
                        "value": "waste_treatment"
                  },
                  {
                        "label": "Waste Treatment & Transportation Equipment & Services",
                        "value": "transport_error"
                  },
                  {
                        "label": "Spacers & Fluid Mixing equipment",
                        "value": "mixing_error"
                  },
                  {
                        "label": "Solids Solutions & Fluid Treatment Equipment & Services",
                        "value": "solutions_error"
                  }
            ],
            "answer": [
                  "filtration",
      ...
      },
      {
            ...
            "options": [
                  ...
                  {
                        "label": "Suction section",
                        "value": "suction"
                  },
                  {
                        "label": "Additions section",
                        "value": "additions"
                  },
                  {
      ...
      },
      {
            ...
            "options": [
                  ...
                  {
                        "label": "Centrifuge feed header",
                        "value": "header"
                  },
                  {
                        "label": "Flow distributor",
                        "value": "distributor"
                  },
                  {
                        "label": "Gumbo box",
      ...
      },
      {
            ...
            "options": [
                  {
                        "label": "Shale shaker, desilter, desander, & centrifuge",
                        "value": "seq_1"
                  },
                  {
                        "label": "Shale shaker, centrifuge, desander",
                        "value": "seq_2"
                  },
                  {
                        "label": "Shale shaker, Mud Cleaner, Low Speed Centrifuge, High Speed Centrifuge",
                        "value": "seq_3"
                  },
                  {
                        "label": "Shale Shaker, desander, desilter & centrifuge",
                        "value": "seq_4"
                  },
                  {
                        "label": "Shale shaker, centrifuge, desander & desilter",
                        "value": "seq_5"
                  }
            ],
            "answer": "seq_3",
      ...
      },
      {
            ...
            "options": [
                  {
                        "label": "Hydrocyclones (desander and desilter)",
                        "value": "hydrocyclones"
                  },
                  {
                        "label": "Shale shakers",
      ...
      },
      {
            ...
            "options": [
                  ...
                  {
                        "label": "Accelerated sedimentation",
                        "value": "sedimentation"
                  },
                  {
      ...
      },
      {
            ...
            "options": [
                  {
                        "label": "Un-weighted systems",
                        "value": "unweighted"
                  },
                  {
                        "label": "Completions Brine",
                        "value": "brine"
                  },
                  {
                  ...
                  {
                        "label": "Non Aqueous fluid systems",
                        "value": "naf"
                  }
            ],
            "answer": "weighted",
      ...
      },
      {
            ...
            "options": [
                  {
                        "label": "Max solids removal",
                        "value": "max_solids"
                  },
                  {
                        "label": "Particle size reduction",
                        "value": "degradation"
                  },
                  {
                        "label": "Rheology control (barite recovery)",
                        "value": "barite_recovery"
                  },
                  {
