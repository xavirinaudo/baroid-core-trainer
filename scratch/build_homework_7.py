...
questions = [
    {
        ...
        "options": [
            {"label": "Feed accelerator", "value": "feed_accelerator"},
            {"label": "Pillow blocks", "value": "pillow_blocks_error"},
            {"label": "Feed nozzle liners", "value": "feed_nozzle_liners"},
            {"label": "Solids discharge wear inserts", "value": "solids_discharge_inserts"},
            {"label": "Feed tube", "value": "feed_tube"}
        ],
        "answer": [
            "feed_accelerator",
            "feed_nozzle_liners",
    ...
    },
    {
        ...
        "options": [
            {"label": "Stops at 1500 psi, restarts at 700 psi", "value": "stop_1500_start_700"},
            {"label": "Stops at 1600 psi, restarts at 1100 psi", "value": "stop_1600_start_1100"},
            {"label": "Stops at 2100 psi, restarts at 1500 psi", "value": "stop_2100_start_1500"},
            {"label": "Stops at 1200 psi, restarts at 600 psi", "value": "stop_1200_start_600"}
        ],
    ...
    },
    {
        ...
        "options": [
            {"label": "1500 psi / 2100 psi", "value": "opt_1"},
            {"label": "1600 psi / 2100 psi", "value": "opt_2"},
            {"label": "1600 psi / 2500 psi", "value": "opt_3"},
            {"label": "1800 psi / 2200 psi", "value": "opt_4"}
        ],
        "answer": "opt_2",
    ...
    },
    {
        ...
        "options": [
            {"label": "Case cover", "value": "case_cover"},
            {"label": "Feed pump starter box case", "value": "starter_box_error"},
            {"label": "Rotodiff cover", "value": "rotodiff_cover"},
            {"label": "Belt guard", "value": "belt_guard"},
            {"label": "Electrical control panel case", "value": "panel_case_error"}
        ],
        "answer": [
            "case_cover",
            "rotodiff_cover",
    ...
    },
    {
        ...
        "options": [
            {"label": "14 inch", "value": "14_in"},
            {"label": "17 inch", "value": "17_in"},
            {"label": "18.5 inch", "value": "18_5_in"},
            {"label": "20 inch", "value": "20_in"},
            {"label": "21.5 inch", "value": "21_5_in"}
        ],
        "answer": "21_5_in",
    ...
    },
    {
        ...
        "options": [
            {"label": "Excessive Vibration", "value": "vibration"},
            {"label": "Main Bearing Temperatures", "value": "bearing_temp"},
            {"label": "Excessive Bowl Speed", "value": "bowl_speed"},
            {"label": "Conveyor Clutch Trip", "value": "clutch_trip"},
    ...
    },
    {
        ...
        "options": [
            {"label": "Processing capacity and dryness of solids discarded", "value": "opt_1"},
            {"label": "Density reduction, size and quantity of solids removed", "value": "opt_2"},
            {"label": "All of the above", "value": "all_above"}
        ],
        "answer": "all_above",
    ...
    },
    {
        ...
        "options": [
            {"label": "Quantity and size distribution of total solids", "value": "opt_1"},
            {"label": "Properties of individual solids, feed rate, and drilling fluid properties", "value": "opt_2"},
            {"label": "All of the above", "value": "all_above"}
        ],
        "answer": "all_above",
    ...
    },
    {
        ...
        "options": [
            {"label": "Bowl geometry, centrifugal forces, retention time in the pond, dewatering time on the beach, and torque", "value": "correct_factors"},
            {"label": "Bowl motor size, conveyor motor size, feed tube length, and type of feed pump", "value": "motors_error"},
            {"label": "Feet of head from pump, pressure at feed tube, type of conveyor", "value": "pump_error"},
            {"label": "Height of the centrifuge stand and length of hose from the feed pump", "value": "stand_error"}
        ],
    ...
    },
    {
        ...
        "options": [
            {"label": "G-force and particle settling velocity", "value": "g_force"},
            {"label": "Retention time and dewatering time", "value": "retention"},
            {"label": "Particle settling velocity via mud viscosity changes", "value": "viscosity"},
            {"label": "Dewatering time and conveyor torque", "value": "torque"}
        ],
        "answer": "g_force",
    ...
    },
    {
        ...
        "options": [
            {"label": "G-force and particle settling velocity", "value": "g_force"},
            {"label": "Retention time and dewatering time", "value": "retention_dewatering"},
            {"label": "Particle settling velocity via mud viscosity changes", "value": "viscosity"},
            {"label": "Dewatering time and conveyor torque", "value": "torque"}
        ],
    ...
    },
    {
        ...
        "options": [
            {"label": "G-force and particle settling velocity", "value": "g_force"},
            {"label": "Retention time and dewatering time", "value": "retention"},
            {"label": "Particle settling velocity (by reducing fluid viscosity)", "value": "settling_vel"},
            {"label": "Dewatering time and conveyor torque", "value": "torque"}
        ],
        "answer": "settling_vel",
    ...
    },
    {
        ...
        "options": [
            {"label": "G-force and particle settling velocity", "value": "g_force"},
            {"label": "Retention time and active processing %", "value": "retention"},
            {"label": "Particle settling velocity via mud viscosity changes", "value": "viscosity"},
            {"label": "Dewatering time on the beach and conveyor torque", "value": "dewatering_torque"}
        ],
    ...
    },
    {
        ...
        "options": [
            {"label": "G-force and particle settling velocity", "value": "g_force"},
            {"label": "Retention time and active processing capacity %", "value": "retention_capacity"},
            {"label": "Particle settling velocity via mud viscosity changes", "value": "viscosity"},
            {"label": "Dewatering time and conveyor torque", "value": "torque"}
        ],
    ...
    },
    {
        ...
        "options": [
            {"label": "500.00 G's", "value": "500"},
            {"label": "795.30 G's", "value": "795.30"},
            {"label": "912.45 G's", "value": "912.45"},
            {"label": "1200.00 G's", "value": "1200"}
        ],
        "answer": "795.30",
    ...
    },
    {
        ...
        "options": [
            {"label": "1250.50 RPM", "value": "1250.5"},
            {"label": "1450.25 RPM", "value": "1450.25"},
            {"label": "1613.90 RPM", "value": "1613.90"},
            {"label": "1800.00 RPM", "value": "1800"}
        ],
        "answer": "1613.90",
    ...
    },
    {
        ...
        "options": [
            {"label": "Max solids removal from un-weighted mud", "value": "max_solids_unweighted"},
            {"label": "Control rheology of weighted mud (barite recovery)", "value": "rheology_weighted"},
            {"label": "Chemically enhanced centrifugation (dewatering)", "value": "chemically_enhanced"},
            {"label": "Weight up the active drilling fluid", "value": "weight_up_error"},
            {"label": "Secondary drying of cuttings", "value": "dryer_error"},
            {"label": "Separate barite from drilled solids downhole", "value": "downhole_error"}
        ],
        "answer": [
    ...
    },
    {
        ...
        "options": [
            {"label": "Increase bowl speed, decrease conveyor speed, decrease pond depth, decrease feed rate", "value": "correct_adjust"},
            {"label": "Decrease bowl speed, increase conveyor speed, increase pond depth, increase feed rate", "value": "wrong_1"},
            {"label": "Increase bowl speed, increase conveyor speed, increase pond depth, decrease feed rate", "value": "wrong_2"},
            {"label": "Decrease bowl speed, decrease conveyor speed, decrease pond depth, increase feed rate", "value": "wrong_3"}
        ],
    ...
    },
    {
        ...
        "options": [
            {"label": "High conveyor speed is utilized to ensure discharge (reclaimed barite slurry) remains wet and flows easily", "value": "high_conveyor_wet"},
            {"label": "Low Conveyor speed is utilized to produce dry solids returned to the active system", "value": "low_conveyor_error"},
            {"label": "Low bowl speed is utilized to minimize settling and removal of low-gravity solids (LGS) which should pass to the second centrifuge", "value": "low_bowl_lgs"},
            {"label": "High bowl speed is utilized to remove all solids to be returned to the active system", "value": "high_bowl_error"}
        ],
        "answer": [
            "high_conveyor_wet",
            "low_bowl_lgs"
    ...
    },
    {
        ...
        "options": [
            {"label": "Too high pond depth increases LGS settling (returning LGS to active system); too low pond depth drys the HGS discharge too much, causing it to plug returning chutes", "value": "pond_issues"},
            {"label": "Too high pond depth drys the discharge; too low pond depth causes LGS to return to the active system", "value": "wrong_1"},
            {"label": "Pond depth settings do not impact solids recovery in weighted mud systems", "value": "wrong_2"}
        ],
        "answer": "pond_issues",
    ...
    },
    {
        ...
        "options": [
            {"label": "Increased retention time", "value": "increased_retention"},
            {"label": "Lower volume of fines generated", "value": "fines_error"},
            {"label": "Increased dewatering time on the beach", "value": "dewatering_error"},
            {"label": "Increased G-force potential", "value": "increased_g_force"},
    ...
    },
    {
        ...
        "options": [
            {"label": "Full Hydraulic Drive (FHD)", "value": "fhd"},
            {"label": "Gear Box Drive (GBD)", "value": "gbd"},
            {"label": "Fully automated Drive (FAD)", "value": "fad_error"},
            {"label": "Variable Frequency Drive (VFD)", "value": "vfd"},
            {"label": "Hybrid box drive", "value": "hybrid_error"}
        ],
        "answer": [
            "fhd",
            "gbd",
    ...
    },
    {
        ...
        "options": [
            {"label": "Chemically enhanced waste reduction", "value": "waste_red"},
            {"label": "Dissolved Air flotation", "value": "daf"},
            {"label": "Liquid clarification", "value": "clarification"},
            {"label": "Chemically enhanced solid removal", "value": "chem_enhanced_solids"}
        ],
    ...
    },
    {
        ...
        "options": [
            ...
            {"label": "Hydrocyclone", "value": "hydrocyclone"},
            {"label": "Decanting Centrifuge", "value": "centrifuge"},
            {"label": "Vertical Dryer", "value": "dryer"}
        ],
        "answer": "centrifuge",
    ...
    },
    {
        ...
        "options": [
            {"label": "Vertical Cuttings Dryer", "value": "vcd"},
            {"label": "Secondary Drying Shaker", "value": "drying_shaker"},
            {"label": "Horizontal Cuttings Dryer", "value": "hcd_error"},
            {"label": "Rotary Vacuum Dryer", "value": "vacuum_error"},
            {"label": "Thermal Phase Separator", "value": "thermal_error"},
            {"label": "High Velocity Oil Retainer", "value": "retainer_error"}
        ],
        "answer": [
            "vcd",
            "drying_shaker"
    ...
    },
    {
        ...
        "options": [
            {"label": "Evaporation", "value": "evap_error"},
            {"label": "Centrifugal Force", "value": "centrifugal_force"},
            {"label": "Vacuum reduction", "value": "vacuum_error"},
            {"label": "Filtration (wedged wire screen)", "value": "filtration_screen"},
            {"label": "Gravitational settling", "value": "gravity_error"}
        ],
        "answer": [
            "centrifugal_force",
            "filtration_screen"
    ...
    },
    {
        ...
        "options": [
            {"label": "V-71", "value": "v_71"},
            {"label": "V-77", "value": "v_77_error"},
            {"label": "V-133", "value": "v_133"},
            {"label": "V-311", "value": "v_311_error"}
        ],
        "answer": [
            "v_71",
            "v_133"
    ...
    },
    {
        ...
        "options": [
            {"label": "200 G's", "value": "200"},
            {"label": "300-500 G's", "value": "300_500"},
            {"label": "500-700 G's", "value": "500_700"},
            {"label": "1200+ G's", "value": "1200"}
        ],
        "answer": "300_500",
    ...
    },
    {
        ...
        "options": [
            {"label": "Hydrocyclone", "value": "hydrocyclone_error"},
            {"label": "Drying Shaker", "value": "drying_shaker_error"},
            {"label": "Recovery Tank", "value": "recovery_tank"},
            {"label": "Centrifuge", "value": "centrifuge"},
            {"label": "Pump (centrifuge feed)", "value": "pump"},
            {"label": "Discharge System (augurs/flumes)", "value": "discharge_system"},
            {"label": "Dewatering Unit", "value": "dewatering_error"},
            {"label": "Delivery System (conveyors/vacuum)", "value": "delivery_system"}
        ],
        "answer": [
            "recovery_tank",
            "centrifuge",
    ...
    },
    {
        ...
        "options": [
            {"label": "Rotating slotted drum", "value": "slotted_drum_error"},
            {"label": "Rotating wedged wire basket", "value": "wire_basket"},
            {"label": "Rotating scroll with vertical flights", "value": "vertical_flights"},
            {"label": "Rotating scroll with horizontal flights", "value": "horizontal_flights_error"}
        ],
        "answer": [
            "wire_basket",
            "vertical_flights"
    ...
    },
    {
        ...
        "options": [
            {"label": "Yes", "value": "yes_error"},
            {"label": "No, it requires a centrifuge to treat the recovered liquid phase", "value": "no_requires_centrifuge"}
        ],
    ...
    },
    {
        ...
        "options": [
            {"label": "The vertical dryer is considered a standalone solids control device", "value": "not_standalone"},
            {"label": "Fluid recovered in the collection tank requires no further processing", "value": "no_processing_needed"},
            {"label": "It reduces haul-off and disposal costs", "value": "reduces_costs_error"},
            {"label": "It involves dangerous high-speed elements of operation", "value": "dangerous_error"},
            {"label": "It meets EPA requirements for ROC discharge limits in certain areas", "value": "meets_epa_error"},
            {"label": "It requires very little operator attention and maintenance", "value": "low_maintenance"}
        ],
        "answer": [
            "not_standalone",
    ...
    },
    {
        ...
        "options": [
            {"label": "< 2%", "value": "less_2"},
            {"label": "< 3%", "value": "less_3"},
            {"label": "< 5%", "value": "less_5"},
            {"label": "None of the above", "value": "none"}
        ],
        "answer": "less_5",
    ...
    },
    {
        ...
        "options": [
            {"label": "0.010 inches", "value": "opt_1"},
            {"label": "0.020 inches", "value": "opt_2"},
            {"label": "0.050 inches", "value": "opt_3"},
            {"label": "0.500 inches", "value": "opt_4"}
        ],
        "answer": "opt_2",
...
with open("data/homework_7.js", "w", encoding="utf-8") as f:
    f.write(content)
print("Wrote data/homework_7.js successfully!")
